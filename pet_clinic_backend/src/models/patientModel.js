...
async function list() {
  return withConnection((c) =>
    c
      .execute(
        "SELECT PATIENT_ID, PET_NAME, PET_SPECIES, PET_BREED, PET_AGE, SEX, OWNER_NAME, OWNER_PHONE, OWNER_EMAIL, MEDICAL_NOTES, CREATED_AT FROM PATIENTS ORDER BY PATIENT_ID DESC",
        [],
